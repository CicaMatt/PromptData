...
public class CMSHashManager {
    ...
    private static String getHash(String unhashedData) throws NoSuchAlgorithmException {
        ...
        byte[] hashData = sha512.digest(unhashedData.getBytes());
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Hashed Password: " + getPasswordHash(plaintext));
            System.out.println("Password Verified: " + verifyHashedPassword(plaintext, encrypted));
